<%@ Page Title="" Language="C#" MasterPageFile="~/PMS.Master" AutoEventWireup="true" CodeBehind="ProjectDetailsTeamLeader.aspx.cs" Inherits="PMS.ProjectDetailsTeamLeader" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cp1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function chrck()
        {
            ...
            var a = confirm("Are U sure Want To Update");
            if (a) {
                return true;
            }
            else
...
<asp:GridView id="gd1" runat="server" AutoGenerateColumns="False">
    ...
    <asp:Button ID="btnedit"  runat="server" CssClass="btn btn-default" Text="Update Project Status" OnClick="btnedit_Click" OnClientClick="chrck();"  />
    </div>
                            </div>
                        </div>
                    </div>
