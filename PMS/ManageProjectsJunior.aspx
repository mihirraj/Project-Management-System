<%@ Page Title="" Language="C#" MasterPageFile="~/PMS.Master" AutoEventWireup="true" CodeBehind="ManageProjectsJunior.aspx.cs" Inherits="PMS.ManageProjectsJunior" %>
    ...
    <nav  class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="ManageProjects.aspx"><i class="fa fa-sitemap "></i>Manage Project<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="AddProject.aspx"><i class="fa fa-cogs "></i>Add Project</a>
                            </li>
