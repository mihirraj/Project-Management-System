<%@ Page Title="" Language="C#" MasterPageFile="~/PMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DashboardAdmin.aspx.cs" Inherits="PMS.Dashboard1" %>
    ...
    <nav  class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"  href="DashboardAdmin.aspx"><i class="fa fa-dashboard "></i>Dashboard</a>
                    </li>
                      <li>
    ...
    <div id="page-wrapper" class="page-wrapper-cls">
                     ...
                     <div class="style-box-one " style="border-left:none" >
                            <a href="#">
                                <span>
                                    ...
                                    <asp:ImageButton  ID="image12" runat="server" Width="150px" Height="150px"  ImageUrl='<%#Bind("pimage") %>'/>
                                </span>
            ...
            <div class=" col-md-4 col-sm-4" style="width:100%">
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="5" >
                        <Columns>
