<%@ Page Title="" Language="C#" MasterPageFile="~/PMS.Master" AutoEventWireup="true"  EnableEventValidation="false" CodeBehind="DashboardManager.aspx.cs" Inherits="PMS.DashboardManager" %>
    ...
    <nav  class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"  href="DashboardManager.aspx"><i class="fa fa-dashboard "></i>Dashboard</a>
                    </li>
                      <li>
