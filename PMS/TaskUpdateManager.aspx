<%@ Page Title="" Language="C#" MasterPageFile="~/PMS.Master" AutoEventWireup="true" CodeBehind="TaskUpdateManager.aspx.cs" Inherits="PMS.JuniorTask" %>
        ...
        <nav  class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="TaskUpdateManager.aspx" class="active-menu"><i class="fa fa-sitemap "></i>Task Updates</a>
